  ...
  <div class="main">
    ...
    <div class="content">
          ...
          <div class="activity-list">
            <div class="activity-item">
              ...
              <div class="activity-body">
                <div class="act-title">Nouvel utilisateur créé</div>
            ...
            <div class="activity-item">
              ...
              <div class="activity-body">
                <div class="act-title">Rapport mensuel généré</div>
            ...
            <div class="activity-item">
              ...
              <div class="activity-body">
                <div class="act-title">Échec de connexion (×5)</div>
            ...
            <div class="activity-item">
              <div class="activity-dot" style="background:var(--c-success)"></div>
              <div class="activity-body">
                <div class="act-title">Sauvegarde complète OK</div>
      ...
      <div class="dash-grid">
        ...
        <div class="card">
          <div class="card-header"><div class="card-title">Répartition des rôles</div></div>
          <div style="display:flex;flex-direction:column;gap:12px">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;font-size:13px">
              <span style="display:flex;align-items:center;gap:8px"><span style="width:10px;height:10px;border-radius:50%;background:var(--c-success);display:inline-block"></span>Opérateurs</span>
              <strong>312</strong>
            </div>
            <div style="display:flex;align-items:center;justify-content:space-between;font-size:13px">
